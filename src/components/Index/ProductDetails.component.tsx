        ...
        <section id="latestproducts" className="mt-4 ">
          ...
          <div className="flex flex-col items-center space-y-4 sm:flex-row justify-around sm:items-start text-black">            
            <div className="w-[64%] flex flex-col items-start space-y-2">
              ...
              <div className="ml-4 mr-8 flex flex-row justify-between items-center">
                <img className='w-[12%] h-[18%]' src={`${product.image}`} alt="airpods" />
                <h1 className="text-sm font-light text-center">{product.name}</h1>
                <h1 className="text-sm font-light text-center">{product.price}</h1>
            ...
            <h1 className="pb-1 text-sm font-normal text-center px-6">SUBTOTAL (8) ITEMS</h1>
